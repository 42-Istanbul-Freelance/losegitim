		...
		<html lang="tr">
			<body>
				...
				<footer className="footer">
					<p>&copy; {new Date().getFullYear()} LÖSEV Konferans Sistemi - Eğitmen Arayüzü <span style={{ opacity: 0.7, fontSize: "0.9em", marginLeft: "10px" }}>| Sürüm: v1.1.0 (Açık Kayıt)</span></p>
				</footer>
			</body>
		</html>
	);
