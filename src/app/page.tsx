...
function ConferenceModal({ conf, registered, regLoading, onClose, onRegister, formatDate }: ConferenceModalProps) {
const gradient =
...
>
<div style={{ background: gradient, padding: "22px 20px 18px", position: "relative" }}>
...
<p style={{ color: "#475569", fontSize: "13px", lineHeight: "1.6", margin: "0 0 14px" }}>
{conf.description}
</p>
...
>
{regLoading ? "İşleniyor..." : registered ? "❌ Kaydı İptal Et" : "✅ Kayıt Ol"}
</button>
</div>
</div>
</div>
